(function ($) {
    ...
    var _setupSearchView = function () {
        ...
        this.searchView = $("<div class='search-item-message'><ul></ul></div>")
            .appendTo(that.option.messageLocation)                   // location
    ...
    var _createItems = function (result) {
        ...
        $.each(result, function (index, data) {
            var item = $("<li></li>").appendTo(container).addClass(that.option.listStyle).data("data", data);
            //定义li标签
    ...
    var _messageLocation=function (msg) {
        if(this.option.messageLocation){
            this.option.messageLocation.apply(this,[msg]);
        }
    };
